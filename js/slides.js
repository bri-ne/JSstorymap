...
const slide_3 = {
    ...
    dataUse: 'None',
    showpopups: 'yes',
    content: '<p>While Eye on Surveillance and others have consistently pushed back against surveillance because of its role in perpetuating racial discrimination, there is further concern about the city’s ability to manage the technology responsibly and transparently, even if discrimination concerns were addressed. </p><p>For years, various city officials and the police department assured residents that while some forms of surveillance technology were being used, facial recognition was not. At a City Council meeting in the summer of 2020, where legislation to ban facial recognition software and regulate other technologies was introduced for the first time, City Council members requested clarification about the state of surveillance in New Orleans. Administrator of the Real Time Crime Center, Ross Bourgeois made it clear, stating “Of course the city doesn’t deploy any facial recognition technology in a law enforcement purpose...The city doesn’t have any of that technology available for our use.” Further, Chief Technology Officer Jonathan Wisbey confirmed “We do not currently employ any technology that does that in 2020.” <a href= “https://thelensnola.org/2020/11/12/new-orleans-police-department-using-facial-recognition-despite-years-of-denial/” >the lens</a></p> <p>But by November, the NOPD admitted they had in fact been using facial recognition software in some investigations. While they did not own the software, they were in partnership with state and federal agencies that did, including both the FBI and the <a href= “http://la-safe.org/” >Louisiana State Analytical & Fusion Exchange,  </a> one of many national surveillance centers in the nation. </p> ',
  };
const slide_4 = {
